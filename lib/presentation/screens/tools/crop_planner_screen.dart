                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          hintText: 'e.g., Maize, Cassava, Rice',
                          border: OutlineInputBorder(),
                        ),
                        validator: (v) => v?.isEmpty ?? true ? 'Please enter a crop name' : null,
                      ),
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: _nigeriaStates.map((s) => DropdownMenuItem(value: s, child: Text(s))).toList(),
                        onChanged: (v) => setState(() => _selectedState = v!),
                        decoration: const InputDecoration(border: OutlineInputBorder()),
                      ),
                      const SizedBox(height: 16),
                      Text('Farm Size: \ hectares', style: const TextStyle(fontWeight: FontWeight.w600)),
                      Slider(
                        value: _farmSize,
                        min: 0.1,
                        max: 100,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text('Crop Analysis', style: Theme.of(context).textTheme.titleMedium),
                          ],
                        ),
                        const Divider(),
                        Text(_analysisResult.toString()),
                      ],
                    ),
                  ),
                ),
