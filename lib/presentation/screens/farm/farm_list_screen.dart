        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.agriculture, size: 64, color: AppColors.primary),
            ),
      ...
      child: ListTile(
        ...
        trailing: PopupMenuButton(
          ...
          onSelected: (value) async {
            if (value == 'delete') {
              await _farmRepository.deleteFarm(farm.id);
              _loadFarms();
            }
          },
        ),
          ...
          ElevatedButton(
            onPressed: () async {
              if (nameController.text.isNotEmpty) {
                await _farmRepository.createFarm(name: nameController.text);
